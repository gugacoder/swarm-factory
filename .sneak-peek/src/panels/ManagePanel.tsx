...
import { fetchRunStatus, createStream, initializeStream, harnessStart, harnessStop, fetchHarnessSessions, switchSession } from '@/lib/api'
  ...
  return (
    <div className="h-full overflow-auto p-6">
      <div className="max-w-2xl mx-auto space-y-6">
        ...
        {/* 1. Criar harness */}
        <section className={`rounded-lg border p-4 space-y-3 ${phaseIdx >= 1 ? 'border-border' : 'border-primary/50'}`}>
