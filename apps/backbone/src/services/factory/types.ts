// --- Tipos compartilhados para o namespace /api/factory ---
// Portados de apps/sneak-peek-hub/src/lib/types.ts
...
export type JsonlEvent =
  | { type: 'system'; subtype?: string; model?: string; tools?: string[]; [k: string]: unknown }
  | { type: 'assistant'; message: { content: JsonlContent[]; usage?: Record<string, number>; [k: string]: unknown } }
...
// --- Run Phase ---
export type RunPhase = 'pending' | 'created' | 'initialized' | 'executed';
