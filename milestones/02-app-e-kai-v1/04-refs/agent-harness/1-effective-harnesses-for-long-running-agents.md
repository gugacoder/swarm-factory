...
> **Author:** Justin Young (Anthropic Engineering)
...
![Screenshots taken by Claude through the Puppeteer MCP server as it tested the claude.ai clone.](screenshots-puppeteer-mcp.png)
