...
- **PORTAS**: Antes de iniciar um dev server, SEMPRE mate o processo na porta primeiro:
  - Windows: `npx kill-port 5801 && npm run dev:backbone`
  - Linux/Mac: `lsof -ti:5801 | xargs kill -9 2>/dev/null; npm run dev:backbone`
  - Portas do projeto: hub=5800, backbone=5801, postgres=5810
