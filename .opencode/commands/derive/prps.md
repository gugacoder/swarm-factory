---
description: Deriva PRPs (Product Requirements Prompts) a partir das specs de uma sessão de planning
---
...
```
.planning/.what-is/PRP.md             ← O que é PRP, estrutura, checklist
.planning/.what-is/SPECS.md           ← Formato das specs (para entender os IDs)
```
...
Caminhos:
- **Specs**: `.planning/{sessão}/02-specs/` — fonte de verdade do QUE deve ser feito
- **Output**: `.planning/{sessão}/03-prps/` — PRPs gerados
- **Refs**: `.planning/{sessão}/04-refs/` — referências técnicas

### 3. Leia TODAS as specs

Leia cada arquivo em `.planning/{sessão}/02-specs/` na íntegra. Para arquivos grandes (>500 linhas), leia em chunks de 500 linhas.
...
Conforme `.planning/.what-is/PRP.md`:
...
Aplique o checklist de `.planning/.what-is/PRP.md` em cada PRP antes de finalizar.
