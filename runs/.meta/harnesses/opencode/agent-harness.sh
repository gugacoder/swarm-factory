...
CODER_PROMPT="Execute o protocolo de startup: leia .harness/{session}/config.json e progress.txt, features.json, git log. Rode agent-setup.sh. Implemente a próxima feature failing de maior prioridade cujas dependências estejam passing. Teste, commite, atualize os artefatos."
