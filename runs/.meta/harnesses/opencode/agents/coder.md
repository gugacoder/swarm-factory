---
description: Coding agent para sessões incrementais do agent harness
---
...
- ACOMPANHAMENTO: Mantenha `.harness/{session}/runs/<feature-id>.jsonl` atualizado conforme avança.
- Ao FINAL da sessão:
